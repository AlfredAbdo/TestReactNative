...
export default function Index() {
  const [permissionResponse, requestPermission] = ImagePicker.useMediaLibraryPermissions({ writeOnly: true });
  ...
  // testing the SessionHandlerModule
  /* useEffect(() => {
    (async () => {
  ...
  const onSaveImageAsync = async () => {
    if (Platform.OS !== "web") {
      try {
        ...
        const { Asset } = require("expo-media-library");
